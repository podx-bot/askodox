abstract final class InputSanitizer { static String plainText(String value,{int maxLength=500})=>value.replaceAll(RegExp(r'[<>]'),'').trim().substring(0,value.replaceAll(RegExp(r'[<>]'),'').trim().length.clamp(0,maxLength)); }
