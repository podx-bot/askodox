...
class _ConnectivityBannerState extends ConsumerState<ConnectivityBanner> {
  ...
  Widget build(BuildContext context) {
    ...
    final visible = !dismissed && status != ConnectivityStatus.online;
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        status == ConnectivityStatus.offline ? l10n.offlineCopy : l10n.connectionLimited,
                        maxLines: 2,
