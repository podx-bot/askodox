...
class MockAdminRepository implements AdminRepository {
  @override Future<AdminUser> login(AdminRole role) async => AdminUser(id: 'admin-1', name: 'ASKODOX Admin', role: role);
  ...
  @override List<AdminCatalogProduct> get catalog => const [AdminCatalogProduct(id: 'p1', name: 'Organic Toor Dal', brand: 'ASKODOX Select', category: 'Groceries', subcategory: 'Pulses', variant: 'Organic', packSize: '1 kg', barcodeRef: 'barcode://pending', imageRef: 'ref://product/p1', searchKeywords: ['dal', 'toor', 'కందిపప్పు'])];
