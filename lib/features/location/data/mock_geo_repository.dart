...
const mockNearbyShops = [
 NearbyShop(id:'fresh',name:'PODX Fresh Mart',businessName:'PODX Retail Pvt Ltd',category:'Supermarket',address:'Road 12, Banjara Hills, Hyderabad',point:GeoPoint(17.4170,78.4370),distanceMetres:0,verified:true,trustScore:4.8,isOpen:true,productCount:86,watchlistMatches:3,activeOffers:12),
 NearbyShop(id:'sri',name:'Sri Local Stores',businessName:'Sri Lakshmi Stores',category:'Kirana',address:'Jubilee Hills, Hyderabad',point:GeoPoint(17.4260,78.4430),distanceMetres:0,verified:false,trustScore:4.1,isOpen:true,productCount:44,watchlistMatches:1,activeOffers:4),
 NearbyShop(id:'metro',name:'Metro Daily',businessName:'Metro Daily Foods',category:'Supermarket',address:'Somajiguda, Hyderabad',point:GeoPoint(17.4380,78.4510),distanceMetres:0,verified:true,trustScore:4.9,isOpen:false,productCount:132,watchlistMatches:5,activeOffers:18),
];
