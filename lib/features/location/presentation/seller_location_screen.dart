...
class _SellerLocationScreenState extends State<SellerLocationScreen> {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(padding: const EdgeInsets.all(20), children: [
      ...
      if (confirmed) Card(color: Theme.of(context).colorScheme.primaryContainer, child: ListTile(leading: const Icon(Icons.verified), title: Text(t('Location confirmed', 'లొకేషన్ నిర్ధారించబడింది')), subtitle: Text(t('Your shop now appears in nearby results.', 'మీ షాప్ ఇప్పుడు nearby ఫలితాల్లో కనిపిస్తుంది.')))),
