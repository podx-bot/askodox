...
class MockProductDiscoveryRepository implements ProductDiscoveryRepository {
  ...
  @override OCRResult extractMockText(String source, List<Product> catalog) { const text='SoundCore Wave Wireless Headphones'; return OCRResult(extractedText:text,source:source,matches:matchText(text,catalog)); }
