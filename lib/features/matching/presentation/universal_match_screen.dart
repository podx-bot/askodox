        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              const Text('Choose the best fit. Matching is based on your confirmed requirement, not on commission.', style: TextStyle(color: _mutedInk)),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(match.title, style: const TextStyle(color: _ink, fontSize: 17, fontWeight: FontWeight.w800)),
                      if (match.subtitle != null && match.subtitle!.isNotEmpty) ...[
                        const SizedBox(height: 4), Text(match.subtitle!, style: const TextStyle(color: _mutedInk)),
                      ],
