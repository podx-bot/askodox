...
class RoutedIntentFlow:
    ...
    def __init__(self, router: RealUserIntentRouter, registry: DomainModuleRegistry) -> None:
        self._router = router
    ...
    def evaluate(self, text: str, payload: Mapping[str, Any]) -> RoutedIntentResult:
        ...
        return RoutedIntentResult(route=route, missing=missing, ready=not missing)

    def execute_when_ready(self, text: str, payload: Mapping[str, Any]) -> RoutedIntentResult:
