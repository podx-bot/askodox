...
from app.repositories.universal_review_repository import UniversalReviewRepository
...
class AppContainer:
    def __init__(self) -> None:
        ...
        self.universal_review_repository=UniversalReviewRepository(self.settings.database_path)
